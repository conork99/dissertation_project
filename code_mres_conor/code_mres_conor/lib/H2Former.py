...
from .basic_module_former import *


class Res34_Swin_MS(nn.Module):  ###  low resolution + Multi-scale
    def __init__(self, image_size, block, layers, num_classes=2, zero_init_residual=False, groups=1, width_per_group=64):
...
if __name__ == '__main__':
    model = res34_swin_MS(image_size=128, num_class=2).cuda()
